...
const Search = ({ videos }: { videos:Video[] }) => {
  ...
  return (
    // Pestañas de account/videos para mostrar los rdos de la busqueda
          ...
          { isAccounts ? (
            <div className='md:mt-16'>
              ...
              <div className='md:mt-16 flex flex-wrap gap-6 md:justify-start '>
                {videos.length ? (                                                  // Si hay videos en la respuesta del backend
                    videos.map((post: Video, idx: number) => (                      // mapeamos los videos y los pasamos a un componente VideoCard
